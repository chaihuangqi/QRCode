...
public class ImageUtil {
	...
	public static void waterMarkByText(String logoText, String srcImgPath,
			String targerPath, Integer degree, Integer width, Integer height,
			Float clarity,int clearX,int clearY,int clearWidth,int clearHeight) {
		// 主图片的路径
		InputStream is = null;
		OutputStream os = null;
		try {
	...
	public static void main(String[] args) {
		String srcImgPath = "E:\\AllProject22\\QRCode\\WebRoot\\upload\\www1.png";
		String iconPath = "E:\\AllProject22\\QRCode\\WebRoot\\upload\\logo3.png";
		String targerPath = "E:\\AllProject22\\QRCode\\WebRoot\\upload1\\www1.png";
		// 给图片添加水印
